...
@pytest.mark.asyncio
class TestRecipePatchRoute:
    """Tests for PATCH /recipe/{recipe_id} endpoint."""
    ...
    @pytest.fixture
    async def other_user_recipe(self, db_session: AsyncSession) -> TestRecipe:
    ...
    class TestSuccessScenarios:
        """Tests for successful recipe update scenarios."""
