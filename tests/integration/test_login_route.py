...
@pytest.mark.asyncio
async def test_login_http_exception_passthrough(app: FastAPI, db_session: AsyncSession) -> None:
...
@pytest.mark.asyncio
async def test_login_missing_credentials(app: FastAPI, db_session: AsyncSession) -> None:
...
@pytest.mark.asyncio
async def test_login_invalid_credentials_error(app: FastAPI, db_session: AsyncSession) -> None:
...
@pytest.mark.asyncio
async def test_login_missing_credentials_error(app: FastAPI, db_session: AsyncSession) -> None:
